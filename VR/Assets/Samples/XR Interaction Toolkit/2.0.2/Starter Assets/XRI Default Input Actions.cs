...
public partial class @XRIDefaultInputActions : IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""Custom"",
            ""id"": ""58e12249-22bd-47e0-bc4d-48861352aa32"",
            ""actions"": [
                {
                    ""name"": ""Toogle"",
                    ""type"": ""Button"",
                    ""id"": ""2a9a256b-20d5-4514-a984-93491c45a3d4"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""ToolSelect"",
                    ""type"": ""Button"",
                    ""id"": ""6fc6df3e-97e7-4338-a139-de5d2624c3af"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""4da1d72b-868a-44b0-b225-85fe4f92db7a"",
                ...
                {
                    ""name"": """",
                    ""id"": ""2af5d4e2-67e0-49de-b243-c6022f6df78c"",
    ...
    ""controlSchemes"": [
        ...
        m_Custom_Toogle = m_Custom.FindAction("Toogle", throwIfNotFound: true);
        m_Custom_ToolSelect = m_Custom.FindAction("ToolSelect", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_Custom_Toogle;
    private readonly InputAction m_Custom_ToolSelect;
    public struct CustomActions
    {
        private @XRIDefaultInputActions m_Wrapper;
        public CustomActions(@XRIDefaultInputActions wrapper) { m_Wrapper = wrapper; }
        public InputAction @Toogle => m_Wrapper.m_Custom_Toogle;
        public InputAction @ToolSelect => m_Wrapper.m_Custom_ToolSelect;
        ...
        public void SetCallbacks(ICustomActions instance)
        {
            ...
            {
                @Toogle.started -= m_Wrapper.m_CustomActionsCallbackInterface.OnToogle;
                @Toogle.performed -= m_Wrapper.m_CustomActionsCallbackInterface.OnToogle;
                @Toogle.canceled -= m_Wrapper.m_CustomActionsCallbackInterface.OnToogle;
                @ToolSelect.started -= m_Wrapper.m_CustomActionsCallbackInterface.OnToolSelect;
                @ToolSelect.performed -= m_Wrapper.m_CustomActionsCallbackInterface.OnToolSelect;
                @ToolSelect.canceled -= m_Wrapper.m_CustomActionsCallbackInterface.OnToolSelect;
            }
